...
"manchete3.jpg" 
                ...
                <div className="bottom">
                    ...
                    <a href="#">
                        <p className="message">
                          <br/>Decisão de abrir novas áreas para mineração provoca críticas e intensifica debate sobre políticas ambientais.
                        </p>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093221/g2-200x200.jpg" 
                              ...
                              Só pode ser coisa de dos Antiambientalistas de sempre
                              </div>
                          </section>
                          <section className="comment-box">
                              <div className="profilepic">
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220604085434/GeeksForGeeks-200x200.png" 
                              ...
                              <div className="comment">
                              Gente, precisa equilibrar desenvolvimento econômico e preservação ambiental, quem sabe aí o que ta acontecendo?
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093229/g-200x200.png" 
                              ...
                              <div className="comment">
                              O que ta acontecendo é que essa informação é com certeza dessa recente, mas tem gente que tem ladrão de estimação e e não enxerga nada!
                              </div>
                          </section>
                        </h4>
                    </a>
                    ...
                    <div className="addComments">
                        ...
                        <input type="text"
                               ...
                               />
                        <a href="#" onClick={() => props.savePost(3, like, save, share, comment, window.email, 5)}>Enviar</a>
                    </div>
                </div>
            </div>
            </div>
