...
"manchete1.jpg" 
                ...
                <div className="bottom">
                    ...
                    <a href="#">
                        <p className="message">
                          <br/>Investigações revelam esquema que teria beneficiado aliados políticos.
                        </p>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093221/g2-200x200.jpg" 
                              ...
                              <div className="comment">
                                  Isso é só mais uma armação da mídia golpista para desviar a atenção dos verdadeiros problemas criados pelo governo anterior!
                              </div>
                          </section>
                          <section className="comment-box">
                              <div className="profilepic">
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220604085434/GeeksForGeeks-200x200.png" 
                              ...
                              <div className="comment">
                                  A culpa é toda do PT de novo! Eles sempre roubam e só sabem desviar dinheiro!
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093241/g3-200x200.png" 
                              ...
                              <div className="comment">
                                  Precisamos investigar isso direito e punir quem roubou, sem politicagem
                              </div>
                          </section>
