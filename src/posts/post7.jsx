...
"manchete7.jpg" 
                ...
                <div className="bottom">
                    ...
                    <a href="#">
                        <p className="likes">2569 likes</p>

                    </a>
                    <a href="#">
                        <p className="message">
                          <br/>Revelações sobre manobras para evitar investigações levantam questões sobre o uso de influência e poder para proteger interesses familiares
                        </p>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093221/g2-200x200.jpg" 
                              ...
                              <div className="comment">
                                Tem acabar com o Clã inteiro! Todos sao corruptos!
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093241/g3-200x200.png" 
                              ...
                              <div className="comment">
                              Como se o filho do &#129425; não tivesse cometido crime contra mulher também né? Ah mas daí tá em segredo de justiça pra ninguém saber de nada!
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093229/g-200x200.png" 
                    ...
                    <div className="addComments">
                        ...
                        <input type="text"
                               ...
                               />
                        <a href="#" onClick={() => props.savePost(7, like, save, share, comment, window.email, 9)}>Enviar</a>
                    </div>
                </div>
            </div>
            </div>
