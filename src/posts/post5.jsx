...
"manchete5.jpg" 
                ...
                <div className="bottom">
                    ...
                    <a href="#">
                        <p className="likes">1001 likes</p>

                    </a>
                    <a href="#">
                        <p className="message">
                          <br/>Ocupações recentes reacendem tensões no campo e geram debates acalorados sobre direitos de posse e reforma agrária.
                        </p>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093221/g2-200x200.jpg" 
                              ...
                              <div className="comment">
                                MST é um bando de comunistas que rouba terras sem trabalhar, usa inocentes como escudo e quando produz algo visa lucros! Já viram os preços dos alimentos
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220604085434/GeeksForGeeks-200x200.png" 
                              ...
                              <div className="comment">
                                Os fazendeiros ricos só querem explorar a terra e deixar o povo sem nada! O MST tá certo em lutar pelos direitos dos trabalhadores e por justiça social.
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093241/g3-200x200.png" 
                              ...
                              <div className="comment">
                                Reforma agrária é um tema muito mal elaborado, nunca entendemos ao certo quem é o bandido e quem é o mocinho!
                              </div>
                          </section>
                    ...
                    <div className="addComments">
                        ...
                        <input type="text"
                               ...
                               />
                        <a href="#" onClick={() => props.savePost(5, like, save, share, comment, window.email, 7)}>Enviar</a>
                    </div>
                </div>
            </div>
            </div>
