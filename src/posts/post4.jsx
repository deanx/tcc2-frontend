...
"manchete4.jpg" 
                ...
                <div className="bottom">
                    ...
                    <a href="#">
                        <p className="likes">1103 likes</p>

                    </a>
                    <a href="#">
                        <p className="message">
                          <br/>Propostas para endurecer penas e aumentar vigilância pública geram debate acalorado sobre eficácia e direitos humanos
                        </p>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093221/g2-200x200.jpg" 
                              ...
                              <div className="comment">
                                As medidas devem ser firmes, mas respeitar os direitos humanos!
                              </div>
                          </section>
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093229/g-200x200.png" 
                              ...
                              <div className="comment">
                                Policiamento militar não resolve nada, só aumenta a violência e os abusos
                              </div>
                          </section>
                          <section className="comment-box sub-comment">
                              <div className="profilepic">
...
"https://media.geeksforgeeks.org/wp-content/uploads/20220609093241/g3-200x200.png" 
                              ...
                              <div className="comment">
                                Fala de herdeiro privilegiado que nunca foi assaltado!
                              </div>
                          </section>
                        </h4>
                    </a>
                    ...
                    <div className="addComments">
                        ...
                        <input type="text"
                               ...
                               />
                        <a href="#" onClick={() => props.savePost(4, like, save, share, comment, window.email, 6)}>Enviar</a>
                    </div>
                </div>
            </div>
            </div>
